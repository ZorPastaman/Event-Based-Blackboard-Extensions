...
namespace Zor.EventBasedBlackboard.Components.Operators.RectVector2_Vector2
{
	...
	public sealed class RectNormalizedToPointOperator : SingleReturnBinaryOperator<Rect, Vector2, Vector2>
	{
		protected override Func<Rect, Vector2, Vector2> operation => DefaultOperators.RectNormalizedToPoint;
	}
}
