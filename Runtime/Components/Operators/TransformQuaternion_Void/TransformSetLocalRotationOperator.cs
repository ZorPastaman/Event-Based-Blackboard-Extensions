...
namespace Zor.EventBasedBlackboard.Components.Operators.TransformQuaternion_Void
{
	...
	public sealed class TransformSetLocalRotationOperator : NoReturnBinaryOperator<Transform, Quaternion>
	{
		protected override Action<Transform, Quaternion> operation => DefaultOperators.TransformSetLocalRotation;
	}
}
