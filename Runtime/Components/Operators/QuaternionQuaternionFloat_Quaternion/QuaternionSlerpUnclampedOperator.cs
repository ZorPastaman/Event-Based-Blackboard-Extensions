...
namespace Zor.EventBasedBlackboard.Components.Operators.QuaternionQuaternionFloat_Quaternion
{
	...
	[AddComponentMenu(BlackboardExtensionsAddComponentConstants.OperatorsFolder + "(Quaternion, Quaternion, Float) => (Quaternion)/Quaternion Slerp Unclamped Operator")]
	public sealed class QuaternionSlerpUnclampedOperator :
		SingleReturnTernaryOperator<Quaternion, Quaternion, float, Quaternion>
	{
		protected override Func<Quaternion, Quaternion, float, Quaternion> operation =>
			DefaultOperators.QuaternionSlerpUnclamped;
	}
}
