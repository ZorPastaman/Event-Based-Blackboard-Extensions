...
namespace Zor.EventBasedBlackboard.Components.Operators.QuaternionQuaternionFloat_Quaternion
{
	...
	[AddComponentMenu(BlackboardExtensionsAddComponentConstants.OperatorsFolder + "(Quaternion, Quaternion, Float) => (Quaternion)/Quaternion Lerp Unclamped Operator")]
	public sealed class QuaternionLerpUnclampedOperator :
		SingleReturnTernaryOperator<Quaternion, Quaternion, float, Quaternion>
	{
		protected override Func<Quaternion, Quaternion, float, Quaternion> operation =>
			DefaultOperators.QuaternionLerpUnclamped;
	}
}
