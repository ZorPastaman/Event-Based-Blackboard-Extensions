...
namespace Zor.EventBasedBlackboard.Components.Operators.QuaternionQuaternionFloat_Quaternion
{
	...
	[AddComponentMenu(BlackboardExtensionsAddComponentConstants.OperatorsFolder + "(Quaternion, Quaternion, Float) => (Quaternion)/Quaternion Lerp Operator")]
	public sealed class QuaternionLerpOperator : SingleReturnTernaryOperator<Quaternion, Quaternion, float, Quaternion>
	{
		protected override Func<Quaternion, Quaternion, float, Quaternion> operation =>
			DefaultOperators.QuaternionLerp;
	}
}
